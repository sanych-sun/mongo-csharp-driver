...
namespace MongoDB.Driver.Core.Authentication.Oidc
{
    internal sealed class MongoOidcProviderMechanism : OidcSaslMechanism
    {
        ...
        public override ISaslStep CreateSpeculativeAuthenticationSaslStep(CancellationToken cancellationToken) => Initialize(null, null, null);
        ...
        public override ISaslStep Initialize(IConnection connection, SaslConversation conversation, ConnectionDescription description)
        {
            ...
            var oidcCredentials = _providerWorkflowCredentialsProvider.CreateCredentialsFromExternalSource();
